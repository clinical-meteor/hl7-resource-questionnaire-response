...
JsonRoutes.add("get", "/" + fhirVersion + "/QuestionnaireResponse/:id", function (req, res, next) {
...
JsonRoutes.add("get", "/" + fhirVersion + "/QuestionnaireResponse", function (req, res, next) {
